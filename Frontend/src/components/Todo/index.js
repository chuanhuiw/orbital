...
function Todo() {
    ...
    useEffect(() => {
        ...
        axios.get('https://orbital-orcin.vercel.app/api/getTodoList', {params: { userEmail } })
            .then(result => {
    ...
    const addTask = (e) => {
        ...
        axios.post('https://orbital-orcin.vercel.app/api/addTodoList', { task: newTask, status: newStatus, deadline: newDeadline, userEmail })
            .then(res => {
                console.log(res);
    ...
    const saveEditedTask = (id) => {
        ...
        axios.post('https://orbital-orcin.vercel.app/api/updateTodoList/' + id, editedData)
            .then(result => {
                console.log(result);
                setEditableId(null);
                setEditedTask("");
    ...
    const deleteTask = (id) => {
        axios.delete('https://orbital-orcin.vercel.app/api/deleteTodoList/' + id)
            .then(result => {
                console.log(result);
                window.location.reload();
            })
    ...
    const toggleFlagged = (id, currentFlagged) => {
        ...
        axios.post(`https://orbital-orcin.vercel.app/api/toggleFlaggedTodo/${id}`, { flagged: updatedFlagged })
            .then(result => {
